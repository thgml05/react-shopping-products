...
import { E as ERROR_MESSAGE } from "./index-7ehrdv9J.js";
...
const handlers = [
  http.get(`${"http://techcourse-lv2-alb-974870821.ap-northeast-2.elb.amazonaws.com"}/products`, ({ request }) => {
    ...
    let content2 = [...productData.content];
    ...
    const paged = content2.slice(start, start + size);
    return HttpResponse.json({
      content: paged,
      totalElements: content2.length,
      totalPages: Math.ceil(content2.length / size),
      number: page,
      size
    });
  }),
